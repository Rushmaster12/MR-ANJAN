...
module.exports = Taira = async (Taira, m, chatUpdate, store) => {
  try {
    ...
    //     const menulist = `
    //     Hii ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: Kai to take your WhatsApp usage into next level.
...
📞 For inquiries, Mr anjan at +919883457657
...
const smallinput = budy.toLowerCase();
    ...
    switch (command) {
      ...
      case 'sc': case 'script': case 'sourcecode': {
        ...
        teks = `* 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋  Script*\n\n*Repo Stars*: ${data.stargazers_count}⭐\n*Repo Forks*: ${data.forks_count} forks\n*Repo link*: https://github.com/OfficialAnjanv2/MR-ANJAN\n\nDont forget to follow Me *GitHub* https://github.com/OfficialAnjanv2 and give a ⭐️ to my projects. `
        /*  let buttons = [
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdreply: {
              title: "𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 ",
              body: " ",
              thumbnailUrl: "https://telegra.ph/file/c2074e6f71e4329e3da8b.jpg",
              mediaType: 1,
      ...
      case "link": {
        ...
        try {
          ...
          let { data } = await axios.get('https://api.github.com/repos/OfficialAnjanv2/HOTARO-MD');
          let teks = `https://github.com/OfficialAnjanv2/HOTARO-MD*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/OfficialAnjanv2/HOTARO-MD\n\nDon't forget to follow me on *GitHub* and give a ⭐️ to my projects.`;
              ...
              message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  header: proto.Message.InteractiveMessage.Header.create({
                    title: "𖤍©𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋2024𖤍",
                    subtitle: "𖤍𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋𖤍 ",
                  ...
                  nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [
                      {
                        "name": "cta_url",
                        "buttonParamsJson": "{\"display_text\":\"Repository\",\"url\":\"https://github.com/OfficialAnjanv2/HOTARO-MD\",\"merchant_url\":\"https://github.com/OfficialAnjanv2/HOTARO-MD\"}"
                      }
                    ]
                  })
                })
...
/*      case 'slot': case 'spin': {
      ...
      */
      ...
      case 'emoji': {
        ...
        emoji.get(args.join(" ")).then(async (emoji) => {
          let mese = await Taira.sendMessage(m.chat, { image: { url: emoji.images[4].url }, caption: `𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 ` }, { quoted: m })
      ...
      case 'ghstalk': case 'githubstalk': case 'github': {
        ...
        if (!q) return reply(`Give me a user name like *${prefix}github OfficialAnjanv2*`)
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'gitclone':
        ...
        if (!args[0]) {
          return reply(`Please provide the GitHub repository link.\nExample:\n${prefix}${command} https://github.com/OfficialAnjanv2/HOTARO-MD`);
        }
      ...
      case 'listpc': {
        ...
        let teks = ` 「  𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋  ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ pm user list  」\n\nTotal ${anu.length} users are using 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 in personal chat.`
        for (let i of anu) {
      ...
      case 'banchat': case 'bangroup': case 'banmode': {
        ...
        if (args[0] === "on") {
          if (isBanChat) return reply('This Group is Already Banned from using 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 !');
          banchat.push(from);
          reply('This Group has been banned from using 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 !');
          ...
          let off = banchat.indexOf(from);
          banchat.splice(off, 1);
          reply('This Group has been *unbanned* from using 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 !');
        } else {
...
*Message : ${text}*\n\n`
      ...
      */
        ...
        if (isCreator) {
          ...
          Taira.query({
            ...
            if (sizny < 20) {
              ...
              sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "919883457657@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
            } else if (sizny > 20) {
              await Taira.groupAcceptInvite(vcc).then(async (res) => reply(jsonformat(res))).catch(_ => _)
              reply("Joined !")
            } else {
      ...
      case "tts": case "texttospeech": case "say": case "speak": {
        ...
        Taira.sendMessage(m.chat, { audio: { url: texttospeechurl, }, mimetype: "audio/mpeg", fileName: `AnjanSpeechEngine.mp3`, }, { quoted: m, });
      }
        break;
      ...
      case 'ig': {
        ...
        if (isBanChat) return reply(mess.bangc);
        if (args[0] === "mp4") {
          Taira.sendMessage(from, { video: { url: args[1] }, caption: '𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 ', mimetype: 'video/mp4' }, { quoted: m })
        } else if (args[0] === "jpg") {
          Taira.sendMessage(from, { image: { url: args[1] }, caption: '𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 ' }, { quoted: m })
        } else {
          reply("Error! ")
        }
      }
...
*/
      ...
      case 'ytvd': case 'video': case 'ytvideo': case 'ytmp4': {
        ...
        Taira.sendMessage(from, { video: { url: ytmp4play.videoUrl }, mimetype: "video/mp4", caption: anu.title + ' By *𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋*', }, { quoted: m })
      }
      ...
      let buttonMessage = {
      image: { url: anu.thumbnail },
      caption: `「  Mr-anjan Youtube Downloader  」
      ...
      */
      ...
      case 'ytmp3': {
        ...
        await Taira.sendMessage(from, { document: fs.readFileSync(ytmp3play2.path), fileName: 'Anjan_YTmp3_Downloader.mp3', mimetype: 'audio/mpeg', }, { quoted: m })
      }
        break;
      ...
      case 'ytvd2': case 'ytmp4': {
        ...
        Taira.sendMessage(from, { video: { url: ytmp4play2.videoUrl }, mimetype: "video/mp4", caption: 'Downloaded by *𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 *', }, { quoted: m })
      }
        break;
      ...
      case 'swm': case 'take': case 'stickerwm': case 'steal': {
        ...
        if (!args.join(" ")) return reply(`use -take 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 |By: 𝐚𝐧𝐣𝐚𝐧👀🦋 `)
        const swn = args.join(" ")
      ...
      case 'sgif': case 'sticker': case 's': {
        ...
        if (/image/.test(mime)) {
          let media = await quoted.download()
          let encmedia = await Taira.sendImageAsSticker(m.chat, media, m, { packname: '𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 ', author: global.author })
          await fs.unlinkSync(encmedia)
        } else if (/video/.test(mime)) {
          if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds!')
          let media = await quoted.download()
          let encmedia = await Taira.sendVideoAsSticker(m.chat, media, m, { packname: '𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋 ', author: global.author })
          await fs.unlinkSync(encmedia)
        } else {
...
╰════════════════ ⪨`;
            ...
            viewOnceMessage: {
              message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  header: proto.Message.InteractiveMessage.Header.create({
                    ...(await prepareWAMessageMedia({ image: { url: 'https://telegra.ph/file/c2074e6f71e4329e3da8b.jpg' } }, { upload: Taira.waUploadToServer })),
                  ...
                  nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                    buttons: [
                      ...
                      {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"𖤍REPO𖤍","url":"https://github.com/OfficialAnjanv2/MR-ANJAN","merchant_url":"https://github.com/OfficialAnjanv2/MR-ANJAN"}`

                      },
                      {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"Supprt Gc👀🦋","url":"https://chat.whatsapp.com/JrA3XLQtyka0muECxfYQTR","merchant_url":"https://chat.whatsapp.com/JrA3XLQtyka0muECxfYQTR"}`
                      },
                      {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋","url":"https://wa.me/919883457657","merchant_url":"https://wa.me/919883457657"}`
                      }
                    ]
                  })
                })
      ...
      case '':
        if (isCmd) {
          ...
          reply(`Hi ${pushname}👋 ,I am 𝐌𝐫-𝐚𝐧𝐣𝐚𝐧👀🦋  by 𝐚𝐧𝐣𝐚𝐧👀🦋 . Do you need any help ?`)
        }
